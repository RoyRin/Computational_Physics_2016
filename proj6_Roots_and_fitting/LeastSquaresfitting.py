...
p.errorbar(x,y,sig) # Plot error bars at the postions of x and y
...
#S is the sum of all the 1/error^2
#Sx is the sum of all the xi/error^2
#Sy is the sum of all the yi/error^2
#Sxx  is the sum of all the xi^2/error^2
#Sxy is the sum of all the xi*yi/error^2
#Syy is the sum of all the yi^2/error^2
# our goal is to minimize D = S*Sxx - Sx^2
